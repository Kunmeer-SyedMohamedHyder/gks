...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GreenSchedulingArgs)(nil), (*config.GreenSchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_GreenSchedulingArgs_To_config_GreenSchedulingArgs(a.(*GreenSchedulingArgs), b.(*config.GreenSchedulingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GreenSchedulingArgs)(nil), (*GreenSchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GreenSchedulingArgs_To_v1_GreenSchedulingArgs(a.(*config.GreenSchedulingArgs), b.(*GreenSchedulingArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_GreenSchedulingArgs_To_config_GreenSchedulingArgs(in *GreenSchedulingArgs, out *config.GreenSchedulingArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.TokenURL, &out.TokenURL, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_string_To_string(&in.ClientID, &out.ClientID, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_string_To_string(&in.ClientSecret, &out.ClientSecret, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_string_To_string(&in.SICHostname, &out.SICHostname, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_float64_To_float64(&in.CO2DecayWeight, &out.CO2DecayWeight, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_float64_To_float64(&in.TotalCO2Weight, &out.TotalCO2Weight, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_float64_To_float64(&in.CostWeight, &out.CostWeight, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_float64_To_float64(&in.DecayRate, &out.DecayRate, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_string_To_string(&in.TimeSeriesInterval, &out.TimeSeriesInterval, s); err != nil {
		return err
	}
...
// Convert_v1_GreenSchedulingArgs_To_config_GreenSchedulingArgs is an autogenerated conversion function.
func Convert_v1_GreenSchedulingArgs_To_config_GreenSchedulingArgs(in *GreenSchedulingArgs, out *config.GreenSchedulingArgs, s conversion.Scope) error {
	return autoConvert_v1_GreenSchedulingArgs_To_config_GreenSchedulingArgs(in, out, s)
}

func autoConvert_config_GreenSchedulingArgs_To_v1_GreenSchedulingArgs(in *config.GreenSchedulingArgs, out *GreenSchedulingArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.TokenURL, &out.TokenURL, s); err != nil {
		return err
	}
	if err := metav1.Convert_string_To_Pointer_string(&in.ClientID, &out.ClientID, s); err != nil {
		return err
	}
	if err := metav1.Convert_string_To_Pointer_string(&in.ClientSecret, &out.ClientSecret, s); err != nil {
		return err
	}
	if err := metav1.Convert_string_To_Pointer_string(&in.SICHostname, &out.SICHostname, s); err != nil {
		return err
	}
	if err := metav1.Convert_float64_To_Pointer_float64(&in.CO2DecayWeight, &out.CO2DecayWeight, s); err != nil {
		return err
	}
	if err := metav1.Convert_float64_To_Pointer_float64(&in.TotalCO2Weight, &out.TotalCO2Weight, s); err != nil {
		return err
	}
	if err := metav1.Convert_float64_To_Pointer_float64(&in.CostWeight, &out.CostWeight, s); err != nil {
		return err
	}
	if err := metav1.Convert_float64_To_Pointer_float64(&in.DecayRate, &out.DecayRate, s); err != nil {
		return err
	}
	if err := metav1.Convert_string_To_Pointer_string(&in.TimeSeriesInterval, &out.TimeSeriesInterval, s); err != nil {
		return err
	}
...
// Convert_config_GreenSchedulingArgs_To_v1_GreenSchedulingArgs is an autogenerated conversion function.
func Convert_config_GreenSchedulingArgs_To_v1_GreenSchedulingArgs(in *config.GreenSchedulingArgs, out *GreenSchedulingArgs, s conversion.Scope) error {
	return autoConvert_config_GreenSchedulingArgs_To_v1_GreenSchedulingArgs(in, out, s)
}
